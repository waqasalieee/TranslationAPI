...
class LocaleFactory extends Factory
{
    ...
    {
        // A more comprehensive mapping of language codes (ISO 639-1) to language names
        ...
        // Select a random language code from the list
        $code = $this->faker->unique()->randomKey($languages);

        return [
            'code' => $code, // Valid language code (ISO 639-1)
            'name' => $languages[$code], // Name corresponding to the code
        ];
    }
}
